...
describe("Given I am connected as an employee", () => {
  describe("When I am on Bills Page", () => {
    ...
    test("Then bills should be ordered from earliest to latest", () => {
      ...
      expect(datesSorted).toEqual(datesSorted)
    })

 
    describe("When I click on the new bill Button", () => {
      test("Then I will go to the bill form", () => {
    ...
    describe("When I go to the bills page and it's loading", () => {
    ...
    describe("When I am on the bills page and receive an error message", () => {
      test("Then, the error page wil be display", () => {
    ...
    //Test d'intégration GET de l'exercice
